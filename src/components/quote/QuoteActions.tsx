...
export function QuoteActions({
  ...
  return (
    <div className="pointer-events-none absolute inset-x-0 bottom-[calc(env(safe-area-inset-bottom)+6rem)] z-30 flex justify-center px-4">
      <div className="pointer-events-auto flex items-center gap-1 rounded-full border border-stone-200/60 bg-white/58 px-2 py-1.5 shadow-[0_18px_36px_rgba(28,25,23,0.16)] backdrop-blur-xl">
...
function ActionButton({
  ...
  return (
    <button
      aria-label={label}
      className={cn(
        'flex h-10 w-10 items-center justify-center rounded-full text-stone-600 transition hover:bg-white/70 hover:text-stone-900 active:scale-[0.96]',
