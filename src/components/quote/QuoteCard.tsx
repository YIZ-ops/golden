...
export const QuoteCard = forwardRef<HTMLDivElement, QuoteCardProps>(function QuoteCard(
  ...
  return (
    <article
      className={cn(
        'flex h-[calc(100vh-12rem)] min-w-full snap-center items-center justify-center px-5 py-4 transition-opacity duration-300',
    ...
    >
      <div
        ...
        style={{
          ...
          paddingBottom: `${cardPadding + 144}px`,
      ...
      >
        ...
        <span
          aria-hidden="true"
          className="pointer-events-none absolute left-6 top-2 font-display text-[9rem] leading-none text-current/10"
        >
          “
        </span>
        <span
          aria-hidden="true"
          className="pointer-events-none absolute bottom-16 right-6 font-display text-[9rem] leading-none text-current/10"
        >
          ”
        </span>
        <div className="relative z-10 flex h-full flex-col">
          ...
          <div className="flex flex-1 items-center justify-center">
            <p className="relative max-w-[18rem] font-serif text-[1.18em] leading-[1.72]">{quote.content}</p>
          </div>
