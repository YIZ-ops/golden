...
export const QuoteCard = forwardRef<HTMLDivElement, QuoteCardProps>(function QuoteCard(
  ...
  return (
    <article
      className={cn(
        'flex min-h-[34rem] snap-start items-center justify-center px-1 py-4 transition-opacity duration-300',
    ...
    >
      <div
        ...
        className={cn(
          'relative w-full overflow-hidden rounded-[2.5rem] border border-stone-200/70 shadow-[0_20px_50px_rgba(28,25,23,0.08)]',
          active ? 'ring-1 ring-stone-300/60' : '',
        )}
        style={{
          background: stylePreset.background,
          padding: `${stylePreset.padding}px`,
