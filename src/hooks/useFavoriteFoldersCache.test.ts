...
describe("useFavoriteFoldersCache", () => {
  it("should cache folders and not refetch for 5 minutes", async () => {
    const mockFolders = [
      { id: "1", name: "Folder 1", quoteCount: 5, isDefault: false },
      { id: "2", name: "Folder 2", quoteCount: 3, isDefault: false },
    ];
  ...
  it("should refresh folders when refresh is called", async () => {
    const mockFolders = [{ id: "1", name: "Folder 1", quoteCount: 5, isDefault: false }];
    const updatedFolders = [
      { id: "1", name: "Folder 1", quoteCount: 6, isDefault: false },
      { id: "2", name: "Folder 2", quoteCount: 3, isDefault: false },
    ];
